...
const tempoObjetivo1 = new Date("2026-12-09");
const tempoObjetivo2 = new Date("2027-03-08");
const tempoObjetivo3 = new Date("2026-11-07");
const tempoObjetivo4 = new Date("2027-03-08");
